...
data = {
    "wegmans":{
            "store_api": ["https://shop.wegmans.com/api/v2/store_products?limit=20&search_term="],
            "cat_url": ["https://shop.wegmans.com/api/v2/categories/store/1"],
...
for i in data:
    ...
    ws.append(name,base_price)
            
wb.save('wegmans.xlsx')       
